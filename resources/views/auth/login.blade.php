      ...
      <div class="col-md-6 col-md-offset-3">
        <div class="userccount">
          <div class="userbtns">
            ...
            $c_or_e = isset($type) ? ($type == 'freelancer' ? 'candidate' : 'employer') : 'employer';
			?>
              <li class="{{($c_or_e == 'candidate')? 'active':'hide'}}" style='width:100%'><a data-toggle="tab" href="#candidate" aria-expanded="true">{{__('Freelance')}}</a></li>
              <li class="{{($c_or_e == 'employer')? 'active':'hide'}}" style='width:100%'><a data-toggle="tab" href="#employer" aria-expanded="false">{{__('Employer')}}</a></li>
            </ul>
          </div>
          ...
          <!-- sign up form -->
          <div class="newuser"><i class="fa fa-user" aria-hidden="true"></i> {{__('New User')}}? <a href="{{ $c_or_e == 'candidate' ? route('register') : route('recruiterregister')}}">{{__('Register Here')}}</a></div>
