        ...
        <div class="userccount">
          <div class="userbtns">
            ...
            $c_or_e = old('candidate_or_employer', 'candidate');
			        ?>
              <li class="{{($c_or_e == 'candidate')? 'active':''}}"><a data-toggle="tab" href="#candidate" aria-expanded="true">{{__('Freelance')}}</a></li>
              <li style="width:100%"  class="{{($c_or_e == 'employer')? 'active':''}}"><a data-toggle="tab" href="#employer" aria-expanded="false">{{__('Employer')}}</a></li>
            </ul>
          </div>
