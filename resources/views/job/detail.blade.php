...
<div class="listpgWraper">
  ...
  <div class="container"> 
    ...
    <div class="job-header">
      ...
      @if(Auth::check() && Auth::user()->isFavouriteJob($job->slug)) <a href="{{route('remove.from.favourite', $job->slug)}}" class="btn"><i class="fa fa-heart" style="color:red" aria-hidden="true"></i> {{__('Favourite Job')}} </a> @else <a href="{{route('add.to.favourite', $job->slug)}}" class="btn"><i class="fa fa-heart" style="color:red" aria-hidden="true"></i> {{__('Add to Favourite')}}</a> @endif

      <a class="btn report" disabled><i class="fa fa-exclamation-triangle" aria-hidden="true"></i> {{__('Report Abuse')}}</a>
