<h5>{{__('Personal Information')}}</h5>
            ...
            <div class="row">
             ...
             {!! Form::select('country_id', [''=>__('Select Country')]+$countries, $country_id, array('class'=>'form-control', 'id'=>'country_id')) !!}
              ...
              <div class="col-md-12">
                <div class="formrow"><button type="submit" class="btn" style="border-radius:0.3em">{{__('Update Profile and Save')}}  <i class="fa fa-arrow-circle-right" aria-hidden="true"></i></button></div>
              </div>
